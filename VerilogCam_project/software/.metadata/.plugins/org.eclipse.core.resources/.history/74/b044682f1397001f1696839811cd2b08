...
//
//#define NUM_INITIAL_READINGS 50  // Number of readings to gather initially
//#define OUTLIER_THRESHOLD 2.0f   // Threshold for considering a reading as an outlier (in standard deviations)
//
//
//// Function prototypes
...
//int read_distance_from_pio() {
//    return IORD_ALTERA_AVALON_PIO_DATA(PIO_OUT_BASE);  // Read distance data from PIO
//}
//
...
//    int previous_average = 0.0f;  // Initial average value
//    int initial_readings[NUM_INITIAL_READINGS];
//    int num_readings = 0;
//
...
//    	int current_distance = read_distance_from_pio();
//
...
//
//            IOWR_ALTERA_AVALON_PIO_DIRECTION(PIO_OUT_BASE, previous_average);
//
//
//            printf("Smoothed Distance (No Outliers): %d\n", current_distance);
//        }
////            else {
...
//        usleep(100); // Sleep for 100ms, include unistd.h if needed
//    }
//
//    return 0;
//}
