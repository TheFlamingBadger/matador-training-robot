...
module my_softcore_mm_interconnect_0 (
	...
	wire  [95:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> pio_out_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // pio_out_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> pio_out_s1_agent:cp_channel
	...
	wire         pio_out_s1_agent_rp_valid;                                                 // pio_out_s1_agent:rp_valid -> router_006:sink_valid
	wire  [95:0] pio_out_s1_agent_rp_data;                                                  // pio_out_s1_agent:rp_data -> router_006:sink_data
	wire         pio_out_s1_agent_rp_ready;                                                 // router_006:sink_ready -> pio_out_s1_agent:rp_ready
	wire         pio_out_s1_agent_rp_startofpacket;                                         // pio_out_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pio_out_s1_agent_rp_endofpacket;                                           // pio_out_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	my_softcore_mm_interconnect_0_router_002 router_003 (
	...
	my_softcore_mm_interconnect_0_router_004 router_004 (
	...
	my_softcore_mm_interconnect_0_router_004 router_005 (
	...
	my_softcore_mm_interconnect_0_router_002 router_006 (
	...
	my_softcore_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (performance_counter_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_softcore_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_softcore_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_softcore_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_softcore_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (performance_counter_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_softcore_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_softcore_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
