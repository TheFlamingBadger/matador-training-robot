...
testbench_name="drive_logic_tb"   # The testbench used for the simulation
...
verilator $testbench_name.sv --main --exe --timing --trace --assert -Wno-WIDTHEXPAND -Wno-WIDTHTRUNC -Wno-CASEINCOMPLETE
