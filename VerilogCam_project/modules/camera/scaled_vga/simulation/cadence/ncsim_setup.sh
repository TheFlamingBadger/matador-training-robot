...
# ACDS 20.1 711 win32 2024.09.19.13:41:10
...
# ----------------------------------------
# If vga_scaled is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_scaled_avalon_st_adapter_channel_adapter_0.sv" -work channel_adapter_0      -cdslib ./cds_libs/channel_adapter_0.cds.lib     
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_scaled_avalon_st_adapter.v"                    -work avalon_st_adapter      -cdslib ./cds_libs/avalon_st_adapter.cds.lib     
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_scaled_video_vga_controller_0.v"               -work video_vga_controller_0 -cdslib ./cds_libs/video_vga_controller_0.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_scaled_video_scaler_0.v"                       -work video_scaler_0         -cdslib ./cds_libs/video_scaler_0.cds.lib        
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/vga_scaled.v"                                                                                                                               
fi
