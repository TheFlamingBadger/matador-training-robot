...
testbench_name="image_processor_tb"   # The testbench used for the simulation
...
verilator $testbench_name.sv --main --exe --timing --trace -Wno-WIDTHEXPAND -Wno-WIDTHTRUNC --assert
