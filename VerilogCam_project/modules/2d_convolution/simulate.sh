...
testbench_name="twod_convolution_filt_tb"   # The testbench used for the simulation
...
verilator $testbench_name.sv --main --exe --timing --trace -Wno-WIDTHTRUNC -Wno-WIDTHEXPAND --assert
