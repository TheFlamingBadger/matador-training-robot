...
testbench_name="address_generator_tb"   # The testbench used for the simulation
...
verilator $testbench_name.sv --main --exe --timing --trace --assert -Wno-WIDTHEXPAND -Wno-WIDTHTRUNC
